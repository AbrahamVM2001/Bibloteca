              ...
              <div class="timeline sticky-top">
                <div class="events-wrapper">
                  <div class="events" style="width: 800px;">
                    <ol>
                    <li><a href="javascript:;" data-date="portada"
                            class="selected" style="left: 10px;">
                            Portada
                          </a></li>
                      <?php $pixeles = 120;
                      foreach ($this->fechasPrograma as $key => $value): ?>
                        <li><a href="javascript:;" data-id="<?= base64_encode(base64_encode($value['id_fecha_programa'])); ?>" data-date="<?= $value['fecha_programa']; ?>"
                            class="older-event fecha-seleccionada" style="left: <?= $pixeles ?>px;">
                            <?= date('j ', strtotime($value['fecha_programa'])) . $meses[date('F', strtotime($value['fecha_programa']))]; ?>
                          </a></li>
                        <?php $pixeles += 120; endforeach; ?>
                    </ol>
              ...
              <div class="events-content">
                ...
                <li class="selected" data-date="portada">
                  <hr class="mb-5">
                      ...
                      <h2 class="text-center"><?= $this->datos['nombre_evento']; ?></h2>
                      <hr class="mt-5">
                    </li>
