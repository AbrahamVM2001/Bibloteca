                    ...
                    { "data": "asignaciones", className: 'text-vertical text-center' },
                    {
                        ...
                        render: function (data) {
                            botones = `<div class="col-sm-12 col-md-12 col-lg-12 col-<xl-12 d-flex justify-content-between align-items-center" >
                                <button data-id="${data.id_profesor}" data-prof="${data.profesor}" data-programa="${data.fk_id_programa}" data-bs-toggle="tooltip" title="Temas asignados" type="button" class="btn btn-info temas-asignados"><i class="fa-solid fa-list"></i></button>
                                <button data-id="${data.id_profesor}" data-prof="${data.profesor}" data-programa="${data.fk_id_programa}" data-bs-toggle="tooltip" title="Previsualizar Cartas" type="button" class="btn btn-secondary visualizar-cartas"><i class="fa-solid fa-magnifying-glass"></i></button>
                                <button data-id="${data.id_profesor}" data-prof="${data.profesor}" data-programa="${data.fk_id_programa}" data-bs-toggle="tooltip" title="Enviar cartas" type="button" class="btn btn-success enviar-cartas"><i class="fa-solid fa-envelope-open-text"></i></button>
                                </div>`;
                            return botones;
                        },
