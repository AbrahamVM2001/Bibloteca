$(function () {
    ...
    async function cardsEventos() {
        try {
            let peticion = await fetch(servidor + `catalogos/eventos`);
            ...
            response.forEach((item, index) => {
                jQuery(`
                    <a href="${servidor}catalogos/programas/${btoa(btoa(item.id_evento))}/${btoa(item.nombre_evento)}" class="col-sm-12 col-md-12 col-lg-4 col-xl-4 mb-3">
